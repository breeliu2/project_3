...
var instanceWarned = /* @__PURE__ */ Object.create(null);
var warnCount = /* @__PURE__ */ Object.create(null);
...
var compatModelEventPrefix = `onModelCompat:`;
var warnedTypes = /* @__PURE__ */ new WeakSet();
...
function convertLegacyRenderFn(instance) {
  ...
  const render2 = Component2.render;
...
var skipLegacyRootLevelProps = makeMap(
...
var normalizedFunctionalComponentMap = /* @__PURE__ */ new Map();
var legacySlotProxyHandlers = {
  get(target, key) {
...
function installCompatInstanceProperties(map2) {
  ...
  extend(map2, {
    ...
    $slots: (i) => {
      ...
      return true ? shallowReadonly(i.slots) : i.slots;
    },
    $scopedSlots: (i) => {
...
function createCompatVue$1(createApp2, createSingletonApp) {
  ...
  Vue2.version = `2.6.14-compat:${"3.3.4"}`;
  Vue2.config = singletonApp.config;
  Vue2.use = (p2, ...options) => {
    if (p2 && isFunction(p2.install)) {
    ...
    instance.ctx._compat_mount = (selectorOrEl) => {
      ...
      if (true) {
        context.reload = () => {
          ...
          render2(cloned, container, isSVG);
        };
      }
...
var normalizedAsyncComponentMap = /* @__PURE__ */ new Map();
...
var resolveFilter = resolveFilter$1;
var _compatUtils = {
  warnDeprecation,
...
//# sourceMappingURL=chunk-DJTEZ4C6.js.map
